...
class SmartMatchService:
    ...
    @staticmethod
    def get_category_match(source_category, marketplace, user_id, auto_create=False):
        """
        Check DB for existing match - USER ISOLATED.
        """
    ...
    @staticmethod
    def save_category_match(source_category, marketplace, target_id, target_path, user_id):
        """Save a confirmed match to DB - USER ISOLATED."""
        try:
            source_category = (source_category or "").strip()
    ...
    @staticmethod
    def get_brand_match(source_brand, marketplace, user_id):
        """
        Check DB for existing brand match - USER ISOLATED.
        """
    ...
    @staticmethod
    def save_brand_match(source_brand, marketplace, target_id, target_name, user_id):
        try:
            source_brand = (source_brand or "").strip()
