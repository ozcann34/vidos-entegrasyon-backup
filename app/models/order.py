...
class Order(db.Model):
    ...
    marketplace_discount = db.Column(db.Float, default=0.0) # Pazaryeri/Satıcı indirimi
    ...
    payout_promised = db.Column(db.Float, default=0.0)  # Hak edilen hakediş tutarı
    settlement_status = db.Column(db.String(20), nullable=True) # kesinkeşti, bekliyor, vb.
