...
class CategoryMapping(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('user_id', 'source_category', 'marketplace', name='uq_category_mapping_v2'),
        db.Index('idx_cat_mapping_source_v2', 'user_id', 'source_category'),
    )
...
class BrandMapping(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('user_id', 'source_brand', 'marketplace', name='uq_brand_mapping_v2'),
        db.Index('idx_brand_mapping_source_v2', 'user_id', 'source_brand'),
    )
