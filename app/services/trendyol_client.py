...
class TrendyolClient:
    ...
    def get_settlements(self, transaction_type: str = "Sale", start_date: Optional[int] = None, end_date: Optional[int] = None, page: int = 0, size: int = 100) -> Dict[str, Any]:
        """
        Fetch settlement records (Muhasebe/Finans).
        transaction_type: 'Sale', 'Return', 'Cancel', 'Other', 'Discount', 'Shipping'
        """
        url = f"https://api.trendyol.com/sapigw/suppliers/{self.seller_id}/settlements"
        params = {
    ...
    def get_other_financials(self, start_date: Optional[int] = None, end_date: Optional[int] = None, page: int = 0, size: int = 100) -> Dict[str, Any]:
        """
        Fetch other financial records (Shipping fees, etc.).
        """
        url = f"https://api.trendyol.com/sapigw/suppliers/{self.seller_id}/otherfinancials"
        params = {"page": page, "size": size}
        if start_date: params["startDate"] = start_date
        if end_date: params["endDate"] = end_date
